...
wsj0=/home/kaldi/data/wsj0
wsj1=/home/kaldi/data/wsj1

if false; then
my_local/wsj_data_prep.sh $wsj0/??-{?,??}.? $wsj1/??-{?,??}.?  || exit 1;
...
my_local/wsj_prepare_dict.sh --dict-suffix "_nosp" || exit 1;
...
local/wsj_format_data.sh --lang-suffix "_nosp" || exit 1;
 ...
 # won't always work, it depends what $decode_cmd is.
  (
   ...
   my_local/wsj_train_lms.sh --dict-suffix "_nosp" &&
...
for x in test_eval92 test_eval93 test_dev93 train_si284; do 
 steps/make_mfcc.sh --cmd "$train_cmd" --nj $train_nj1 \
...
steps/train_mono.sh --boost-silence 1.25 --nj $train_nj2 --cmd "$train_cmd" \
...
(
 ...
 steps/decode.sh --nj $dev_nj --cmd "$decode_cmd" exp/mono0a/graph_nosp_tgpr \
   data/test_dev93 exp/mono0a/decode_nosp_tgpr_dev93 && \
 steps/decode.sh --nj $eval_nj --cmd "$decode_cmd" exp/mono0a/graph_nosp_tgpr \
   data/test_eval92 exp/mono0a/decode_nosp_tgpr_eval92 
) &

if false; then

steps/align_si.sh --boost-silence 1.25 --nj $train_nj2 --cmd "$train_cmd" \
...
steps/decode.sh --nj $dev_nj --cmd "$decode_cmd" exp/tri1/graph_nosp_tgpr \
  data/test_dev93 exp/tri1/decode_nosp_tgpr_dev93 || exit 1;
steps/decode.sh --nj $eval_nj --cmd "$decode_cmd" exp/tri1/graph_nosp_tgpr \
...
steps/align_si.sh --nj $train_nj2 --cmd "$train_cmd" \
...
steps/decode.sh --nj $dev_nj --cmd "$decode_cmd" exp/tri2a/graph_nosp_tgpr \
  data/test_dev93 exp/tri2a/decode_nosp_tgpr_dev93 || exit 1;
steps/decode.sh --nj $eval_nj --cmd "$decode_cmd" exp/tri2a/graph_nosp_tgpr \
...
steps/decode.sh --nj $eval_nj --cmd "$decode_cmd" exp/tri2a/graph_nosp_bg5k \
...
steps/decode.sh --nj $dev_nj --cmd "$decode_cmd" exp/tri2b/graph_nosp_tgpr \
  data/test_dev93 exp/tri2b/decode_nosp_tgpr_dev93 || exit 1;
steps/decode.sh --nj $eval_nj --cmd "$decode_cmd" exp/tri2b/graph_nosp_tgpr \
...
steps/decode_biglm.sh --nj $dev_nj --cmd "$decode_cmd" \
...
steps/decode_fmllr.sh --nj $eval_nj --cmd "$decode_cmd" \
...
steps/decode_fmllr.sh --cmd "$decode_cmd" --nj $eval_nj \
  exp/tri3b/graph_nosp_bd_tgpr data/test_eval92 \
  exp/tri3b/decode_nosp_bd_tgpr_eval92 || exit 1;
steps/decode_fmllr.sh --cmd "$decode_cmd" --nj $dev_nj \
...
steps/align_fmllr.sh --nj $train_nj1 --cmd "$train_cmd" \
...
steps/align_fmllr.sh --nj $train_nj3 --cmd "$train_cmd" \
