...
czpScripts/local/resegment/generate_segments.chenzp.sh --nj $my_nj --cmd "$decode_cmd" \
  --noise_oov false --segmentation_opts "$segmentation_opts" --boost-silence $boost_silence_in_vad \
