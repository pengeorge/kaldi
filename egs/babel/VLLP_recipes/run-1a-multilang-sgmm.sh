...
multilang_opt="data/train data/lang $init_ali"
for l in $langres; do
...
if [ ! -f exp/$mldir/ubm5/.done ]; then
  ...
  steps/train_ubm.sh \
    ...
    data/train data/lang $init_ali exp/$mldir/ubm5
...
if [ ! -f exp/$mldir/sgmm5/.done.ml ]; then
  ...
  echo ---------------------------------------------------------------------
  ./czpScripts/ml_sgmm/train_sgmm2_multilang.sh --spk-dim 0 \
