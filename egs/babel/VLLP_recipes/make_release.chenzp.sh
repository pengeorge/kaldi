...
kws_root="$dir/*${dev2shadow}${ext_suffix}*/$subdir"
...
eval_export_kwlist=$outputdir/KWS15_${team}_${corpus}_${scase}_KWS_${prim}-${sysid}_${version}.kwslist${kwlistid}.xml
...
if [ -z $eval_decode_dir ]; then
  eval_decode_dir="$dir/${eval2shadow}${ext_suffix}"
fi
...
eval_export_ctm=$outputdir/KWS15_${team}_${corpus}_${scase}_STT_${prim}-${sysid}_${version}.ctm
