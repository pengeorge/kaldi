...
export train_cmd="queue.pl -q leave1.q@@allhosts -l ram_free=1200M,mem_free=1200M"
export decode_cmd="queue.pl -q leave1.q@@allhosts -l ram_free=1700M,mem_free=1700M"
export cuda_cmd="queue.pl -q gpu.q@@gpuhosts -l gpu=1"
export mkgraph_cmd="queue.pl -q leave1.q@@allhosts -l mem_free=4G,ram_free=4G"
export proxy_cmd="queue.pl -q leave1.q@@allhosts -l ram_free=7G,mem_free=7G"
