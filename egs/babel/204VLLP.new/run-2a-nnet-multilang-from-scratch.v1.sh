  ...
  if ! $ensemble_finetune; then
    ...
    if [ ! -f $dir/.done ]; then
      $train_cmd $dir/log/reinitialize.log \
        nnet-am-reinitialize $input_model exp/tri5_ali/final.mdl $dir/input.mdl || exit 1;
      czpScripts/nnet2/train_pnorm_fast_continue.sh \
        ...
        data/train data/lang exp/tri5_ali $dir/input.mdl $dir || exit 1
