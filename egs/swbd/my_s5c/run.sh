...
tsocks local/swbd1_data_download.sh /home/kaldi/data/swb-1 # BUT,
...
my_local/swbd1_data_prep.sh /home/kaldi/data/swb-1
...
steps/train_mono.sh --nj $nj1 --cmd "$train_cmd" \
  data/train_30kshort data/lang_nosp exp/mono 

steps/align_si.sh --nj $nj1 --cmd "$train_cmd" \
...
steps/align_fmllr.sh --nj $nj1 --cmd "$train_cmd" \
...
steps/make_denlats.sh --nj $nj2 --cmd "$decode_cmd" \
...
steps/train_diag_ubm.sh --silence-weight 0.5 --nj $nj2 --cmd "$train_cmd" \
