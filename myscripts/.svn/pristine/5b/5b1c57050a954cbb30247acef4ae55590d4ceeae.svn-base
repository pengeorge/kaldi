...
# OpenKWS14 primary system
sys_set='word_plp_smbr_ive word_plp_sgmm_ive word_bnf_sgmm_ive word_bnf_ce_ive sub6_plp_smbr syl_plp_smbr_ive phone_plp_smbr'

# comb-7-only-ph-no-ex
#sys_set='word_plp_smbr_ive word_plp_sgmm_ive word_bnf_sgmm_ive word_bnf_ce_ive sub6_plp_smbr_ive syl_plp_smbr_ive phone_plp_smbr'

# comb-7-no-ex
#sys_set='word_plp_smbr word_plp_sgmm word_bnf_sgmm word_bnf_ce sub6_plp_smbr syl_plp_smbr phone_plp_smbr'

# comb-6-no-phone
#sys_set='word_plp_smbr_ive word_plp_sgmm_ive word_bnf_sgmm_ive word_bnf_ce_ive sub6_plp_smbr syl_plp_smbr_ive'

# comb-6-no-sub
#sys_set='word_plp_smbr_ive word_plp_sgmm_ive word_bnf_sgmm_ive word_bnf_ce_ive syl_plp_smbr_ive phone_plp_smbr'

# comb-6-no-ex-no-sub
#sys_set='word_plp_smbr word_plp_sgmm word_bnf_sgmm word_bnf_ce syl_plp_smbr phone_plp_smbr'

# comb-word-dnn+sub-dnn
#sys_set='word_plp_smbr sub6_plp_smbr'

# comb-word-dnn-ex+sub-dnn
#sys_set='word_plp_smbr_ive sub6_plp_smbr'
...
# comb-4-word-no-ex+sub-dnn
#sys_set='word_plp_smbr word_plp_sgmm word_bnf_sgmm word_bnf_ce sub6_plp_smbr'
