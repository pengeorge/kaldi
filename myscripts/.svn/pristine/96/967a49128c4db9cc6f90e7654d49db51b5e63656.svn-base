...
suffix=
transform_dir=exp/tri5_ali # only use in fully-supervised case
bnf_train_stage=-100
bnf_weight_threshold=0.35 # this would override conf in dnn_update_egs_opts only if
                          # --bnf-weight-threshold is written after ${dnn_update_egs_opts[@]}
ali_dir=
