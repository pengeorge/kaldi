...
if [ $stage -le -3 ] && [ -z "$egs_dir" ]; then
  ...
  czpScripts/nnet2/get_egs.get_feat_dim.sh $egs_opts "${extra_opts[@]}" \
...
# TODO init model by converting AffineComponents to FixAffineComponents except the last layer
