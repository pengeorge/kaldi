...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Sum multiple accumulated stats (no transition_accs) files for SGMM training.\n"
        "Usage: sgmm2-sum-shared-accs [options] stats-out stats-in1 stats-in2 ...\n";
    ...
    kaldi::MleAmSgmm2AccsShared sgmm_accs(1.0e-05, true);
